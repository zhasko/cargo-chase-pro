...
const kk: Dict = {
  ...
  truck: { current: "Жүк алатын қала", destination: "Баратын қала", anyDirection: "Кез келген бағыт", comment: "Комментарий", readyDate: "Дайын күні", publishTitle: "Бос көлік қосу", publishSuccess: "Бос көлік қосылды!", noTrucks: "Бос көліктер табылмады", capacity: "Жүк көтерімділігі", driver: "Жүргізуші", onRoute: "Жолға шығу", myListings: "Менің ұсыныстарым", addAvailableTruck: "Бос көлік" },
  ...
  profile: { title: "Профиль", myCargo: "Менің жүктерім", myTruck: "Жолға шығу", favorites: "Таңдаулылар", subscription: "Жазылым", payments: "Төлем тарихы", stats: "Статистика", complaints: "Шағымдар", notifications: "Хабарламалар", settings: "Баптаулар", switchRole: "Рөлді ауыстыру", role: "Рөл", phone: "Телефон" },
...
const ru: Dict = {
  ...
  truck: { current: "Город загрузки", destination: "Город назначения", anyDirection: "Любое направление", comment: "Комментарий", readyDate: "Дата готовности", publishTitle: "Добавить свободный транспорт", publishSuccess: "Свободный транспорт добавлен!", noTrucks: "Свободный транспорт не найден", capacity: "Грузоподъёмность", driver: "Водитель", onRoute: "На линии", myListings: "Мои предложения", addAvailableTruck: "Свободный транспорт" },
  ...
  profile: { title: "Профиль", myCargo: "Мои грузы", myTruck: "На линии", favorites: "Избранное", subscription: "Подписка", payments: "История платежей", stats: "Статистика", complaints: "Жалобы", notifications: "Уведомления", settings: "Настройки", switchRole: "Сменить роль", role: "Роль", phone: "Телефон" },
...
const en: Dict = {
  ...
  truck: { current: "Pickup city", destination: "Destination city", anyDirection: "Any direction", comment: "Comment", readyDate: "Ready date", publishTitle: "Publish an empty truck", publishSuccess: "Truck published!", noTrucks: "No trucks found", capacity: "Load capacity", driver: "Driver", activeSearch: "Active search" },
